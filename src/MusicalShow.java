public abstract class MusicalShow extends Show {
    ...
    public void setMusicAuthor(String musicAuthor) { this.musicAuthor = musicAuthor; }

    public String getLibrettoText() { return librettoText; }
    public void setLibrettoText(String librettoText) { this.librettoText = librettoText; }
    ...
    public String toString() {
        return super.toString() + "\n"
                ...
                + "Либретто: " + librettoText.substring(0, Math.min(librettoText.length(), 50)) + "...";
    }
}
